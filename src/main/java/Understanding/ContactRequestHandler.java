...
public class ContactRequestHandler extends RequestHandler {
    private static final String REGEX_CONTACT_ADRESS = "\\b(vit|vis|vi|habite|habites|demeure|demeures|adresse)\\b";
    private static final String REGEX_CONTACT_BIRTHDAY = "\\b(naissance|naissances|naisance|naissansse|ne|nes|nees|age|ans|an)\\b";
